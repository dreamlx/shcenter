...
export default {
    ...
    methods: {
      ...
      // scriptTagStatus 为 2 的时候，说明两个必需引入的 js 文件都已经被引入，且加载完成
        ...
        (_this.instance === null || _this.reloadPlayer)
                ...
                document.querySelector('#' + _this.playerId) && ( document.querySelector('#' + _this.playerId).innerHTML = '' );
     ...
     */
        ...
        setPoster: function(poster) {
            poster = poster || 'data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==';
            this.instance.tag.setAttribute('poster', poster);
