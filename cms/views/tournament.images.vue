...
<template>
    <div>
        ...
        <Table  :columns="columns7" :data="imageList"></Table>
...
export default {
                                ...
                                'Button',
                                {
                                    ...
                                    on: {
                                        click: () => {
                                            ...
                                            this.visible = true;
                                            this.imgName = this.imageList[params.index].src;
                                        }
                                    }
                                },
                                '预览'
    ...
    methods: {
        showDetail(index){
            this.$router.push({path:'/image/update',query: {id: this.imageList[index].id}});
           //this.createNews();
        },
        getList() {
        ...
        doDel(){
            ...
            .get(
                this.$root.$options.baseURI +
                    '/shcenter/api/sport/image/delete',{params : {id: this.imageList[this.currentRowIndex].id} }
            )
            .then(response => {
                let res = response.data;
