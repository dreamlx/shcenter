...
<template>
    <div>
        ...
        <Table  :columns="columns7" :data="activityList"></Table>
...
export default {
    ...
    methods: {
        showDetail(index){
            this.$router.push({path:'/activity/update',query: {id: this.activityList[index].id}});
        },
        getList() {
            ...
            this.$http
                .get(
                    this.$root.$options.baseURI +
                        '/shcenter/api/sport/activity/list',{params :params }
                )
                .then(response => {
        ...
        doDel(){
            ...
            .get(
                this.$root.$options.baseURI +
                    '/shcenter/api/sport/activity/delete',{params : {id: this.activityList[this.currentRowIndex].id} }
            )
            .then(response => {
                let res = response.data;
