                    ...
                    <div v-if="!video.faked">
                        <div class="img"> 
                          <!--   <img src="../../../assets/play.png" class="play-btn" @click="playVideo(index)" v-if="!video.playing"/> -->
                            <video :src="video.src" :poster=" video.src + '?vframe/jpg/offset/5'"  width="100%"   height="100%" v-if="video.src" :ref='"topVideo_" + index'  controls  @playing="handlePlay(index)" @pause="handlePause(index)"></video>
                        </div>
